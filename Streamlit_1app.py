...
# -----------------------------
# CASE STUDY 1: Insurance Transactions Analysis
# -----------------------------
...
# -----------------------------
# CASE STUDY 2: Insurance Penetration and Growth Potential
# -----------------------------
...
# -----------------------------
    ...
    if "Transacion_amount" in Agg_Trans.columns and "Insurance_amount" in Agg_insurance.columns:
        ...
        ax.bar(merged["State"], merged["Transacion_amount"], label="Transactions", color="skyblue")
        ax.bar(merged["State"], merged["Insurance_amount"], label="Insurance", color="orange")
        plt.xticks(rotation=45)
...
# -----------------------------
# CASE STUDY 4: Transaction Dynamics
# -----------------------------
